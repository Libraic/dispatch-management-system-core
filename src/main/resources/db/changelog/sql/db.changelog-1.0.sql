...
-- changeset libra:001
-- comment: Create the driverMileageUuid-ossp extension
...
COMMENT ON COLUMN t_companies.created_at       IS 'The mileageDate the company was created.';
COMMENT ON COLUMN t_companies.last_updated_at  IS 'The mileageDate the company was last updated.';
COMMENT ON COLUMN t_companies.deleted_at       IS 'The mileageDate the company was deleted.';
...
COMMENT ON COLUMN t_users.birth_date       IS 'The birth mileageDate of the user.';
...
COMMENT ON COLUMN t_users.employment_date  IS 'The mileageDate the user was employed in the dispatching company.';
COMMENT ON COLUMN t_users.dismissal_date   IS 'The mileageDate the user was dismissed from the dispatching company.';
COMMENT ON COLUMN t_users.created_at       IS 'The mileageDate the user was created.';
COMMENT ON COLUMN t_users.last_updated_at  IS 'The mileageDate the user was last updated.';
COMMENT ON COLUMN t_users.deleted_at       IS 'The mileageDate the user was deleted.';
COMMENT ON COLUMN t_users.supervisor_id    IS 'The foreign key that stored the driverMileageUuid of the user that supervises the current user.';
...
COMMENT ON COLUMN t_usercompanies.user_id    IS 'The foreign key that stores the driverMileageUuid of the User.';
COMMENT ON COLUMN t_usercompanies.company_id IS 'The foreign key that stores the driverMileageUuid of the Company.';
...
COMMENT ON COLUMN t_companies.service_date IS 'The mileageDate the Company was created at.';
...
COMMENT ON COLUMN t_companies.start_date IS 'The mileageDate the Company started to receive services from a certain group of dispatchers.';
...
COMMENT ON COLUMN t_drivers.created_at                IS 'The mileageDate the driver was created.';
COMMENT ON COLUMN t_drivers.last_updated_at           IS 'The mileageDate the driver was last updated.';
COMMENT ON COLUMN t_drivers.deleted_at                IS 'The mileageDate the driver was deleted.';
...
COMMENT ON COLUMN t_drivers_mileage.created_at      IS 'The mileageDate the Driver Mileage was created.';
COMMENT ON COLUMN t_drivers_mileage.last_updated_at IS 'The mileageDate the Driver Mileage was last updated.';
COMMENT ON COLUMN t_drivers_mileage.deleted_at      IS 'The mileageDate the Driver Mileage was deleted.';
...
COMMENT ON COLUMN t_drivers_mileage.start_date IS 'The start mileageDate of a particular mileage.';
COMMENT ON COLUMN t_drivers_mileage.end_date   IS 'The end mileageDate of a particular mileage.';
...
COMMENT ON COLUMN t_trailers.created_at      IS 'The mileageDate the Trailer was registered.';
COMMENT ON COLUMN t_trailers.last_updated_at IS 'The mileageDate the Trailer was last updated.';
COMMENT ON COLUMN t_trailers.deleted_at      IS 'The mileageDate the Trailer was deleted.';
...
COMMENT ON COLUMN t_trailers.company_id      IS 'The driverMileageUuid of the Company this trailer was created for.';
...
COMMENT ON COLUMN t_trucks.created_at      IS 'The mileageDate the Truck was registered.';
COMMENT ON COLUMN t_trucks.last_updated_at IS 'The mileageDate the Truck was last updated.';
COMMENT ON COLUMN t_trucks.deleted_at      IS 'The mileageDate the Truck was deleted.';
...
COMMENT ON COLUMN t_trucks.company_id      IS 'The driverMileageUuid of the Company this truck was created for.';
...
COMMENT ON COLUMN t_drivers.truck_id   IS 'The driverMileageUuid of the Truck that is currently assigned to this Driver.';
COMMENT ON COLUMN t_drivers.trailer_id IS 'The driverMileageUuid of the Trailer that is currently assigned to this Driver.';
...
COMMENT ON COLUMN t_accounts.entity_id       IS 'The driverMileageUuid of entity that is represented by this account.';
...
-- changeset libra:027
-- comment: Add the dispatcher_id column to the t_drivers table to store the foreign key to the t_dispatchers table.
ALTER TABLE t_drivers ADD COLUMN dispatcher_id BIGINT;

COMMENT ON COLUMN t_drivers.dispatcher_id IS 'The foreign key to the t_dispatchers table.';

-- changeset libra:028
-- comment: Remove the relationship between the t_drivers_mileage and t_users tables and a relationship that points to t_dispatchers table.
ALTER TABLE t_drivers_mileage
    DROP CONSTRAINT fk_mileage_dispatcher;

ALTER TABLE t_drivers_mileage
    ADD CONSTRAINT fk_mileage_dispatcher FOREIGN KEY (dispatcher_id) REFERENCES t_dispatchers(id);
