...
public class LoadLocationService {
     ...
     * @param endDate the end date (inclusive) used as the upper bound for filtering.
     * @return a list of {@code LoadLocationEntity} objects whose {@code date} is between
     *         {@code startDate} and {@code endDate}, inclusive. If no matching entities are found,
