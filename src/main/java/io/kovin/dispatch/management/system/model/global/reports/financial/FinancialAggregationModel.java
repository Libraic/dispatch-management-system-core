 ...
 * @param startDate         the start loadDate of the timeframe the KPIs will be calculated for.
 * @param endDate           the end loadDate of the timeframe the KPIs will be calculated for.
 */
